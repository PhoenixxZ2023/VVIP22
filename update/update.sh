...
wget -q -O /usr/bin/menu-tor "https://raw.githubusercontent.com/mofukuy/VVIP2/ipuk/update/menu-tor.sh" && chmod +x /usr/bin/menu-tor
...
wget -q -O /usr/bin/rebootvps "https://raw.githubusercontent.com/mofukuy/VVIP2/ipuk/corn/rebootvps.sh" && chmod +x /usr/bin/rebootvps
